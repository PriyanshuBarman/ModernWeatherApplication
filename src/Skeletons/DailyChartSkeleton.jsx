...
const DailyChartSkeleton = () => {
  return (
    <div className="z-10 flex h-56 w-[95%] flex-col items-center justify-between rounded-2xl bg-white/90 to-transparent px-2 pt-5 pb-3 shadow-md shadow-black/80 dark:bg-[#1f1f1f]">
