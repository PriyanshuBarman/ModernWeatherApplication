...
const DailyCards = ({
  ...
  return (
    <div
      onClick={handleClick}
      className="relative flex h-[7em] w-[87%] cursor-pointer items-center justify-evenly overflow-hidden rounded-xl bg-white py-[2%] pl-[1%] text-black shadow-[1.5px_1.5px_3px_1px] shadow-black/50 dark:bg-[#1d1d1d] dark:text-white/80"
    >
      <h1 className="absolute left-0 top-0 w-[33%] rounded-br-2xl bg-black/15 text-center text-[.7em] font-[500] italic leading-4 dark:bg-white/20 dark:text-white/80">
        {dayName}
      </h1>
