...
const Footer = () => {
  return (
    <footer className="mb-6 mt-10 flex h-[6em] w-full flex-col items-center font-[Arial] italic text-black/70 dark:text-white/55">
      ...
      <h1 className="font-dancingScript text-xl">
