...
const SquareDiv = ({ icon, title, unitname, unit }) => {
  ...
  return (
    <div className="relative mb-4 flex h-[7.6rem] w-[8.95rem] flex-col items-center justify-between rounded-[1.1em] rounded-tl-md bg-white/25 pb-1 pr-3 pt-3 shadow-[3px_5px_5px_.2px] shadow-black/50 duration-300 active:shadow-[inset_2px_3px_5px_.1px] dark:bg-black/5 dark:text-white dark:shadow-black">
      ...
      <div className="flex w-full items-center justify-between pl-3 pr-1.5">
        <div className="mb-7 flex pt-4">
          <h1 className="bg-gradient-to-b from-black/90 to-transparent bg-clip-text text-[1.8rem] font-[600] leading-7 text-transparent dark:from-white">
            {unit}
          </h1>
