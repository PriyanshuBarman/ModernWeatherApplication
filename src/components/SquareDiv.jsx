...
function SquareDiv({ icon, title, unitname, unit }) {
  ...
  return (
    <div className="relative mb-4 flex h-[7.6rem] w-[8.95rem] flex-col items-center justify-between rounded-[1.1em] rounded-tl-md bg-white/25 pb-1 pr-3 pt-3 shadow-[3px_5px_5px_.2px] shadow-black/50 active:shadow-[inset_2px_3px_5px_.1px] dark:bg-black/5 dark:text-white dark:shadow-black">
